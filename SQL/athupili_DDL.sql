...
CONSTRAINT D0G_PK  PRIMARY KEY (DOG_ID), 
CONSTRAINT P_DOG_MNTH_CHCK CHECK (DOG_BIRTH_MONTH BETWEEN 1 AND 12),
CONSTRAINT P_DOG_BIRTH_YR_CHCK CHECK (DOG_BIRTH_YEAR BETWEEN 1980 AND 2030),
CONSTRAINT P_DOG_SEX_CHCK CHECK (UPPER(SEX) IN ('M', 'F'))
);
...
DOG_ID CHAR(5) NOT NULL,
BREED_ID CHAR(5) NOT NULL,
PERCENT NUMBER(5,2) DEFAULT 100.0 NOT NULL, 
...
CONSTRAINT  P_DOG_BREED_PERCENTAGE_CHCK CHECK (PERCENT BETWEEN 0 AND 100)
);
...
CONSTRAINT P_OWNER_ZIP_CHCK CHECK (ZIP IN ('18704', '18708', '18651')),
CONSTRAINT P_OWNER_EMAIL_CHCK CHECK (EMAIL LIKE '%_@%_.%_')
);
...
CONSTRAINT P_PET_FK FOREIGN KEY (DOG_ID) REFERENCES P_DOG(DOG_ID),
CONSTRAINT P_PET_UK UNIQUE (PET_DOG_LICENSE_NUM)
); 
...
CONSTRAINT P_PHOTO_FK FOREIGN KEY (DOG_ID) REFERENCES P_DOG(DOG_ID),
...
CONSTRAINT P_SERVICE_CERTIFICATIONS_FK  FOREIGN KEY (DOG_ID) REFERENCES P_SERVICE_DOGS(DOG_ID)
);
